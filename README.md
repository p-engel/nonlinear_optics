...
Using a quasi-3D theoretical model, taking into account cascaded OR,
three-photon absorption (3PA) of the near-infrared radiation, and material 
dispersion/absorption properties, we describe the Terahertz (THz) generation 
through optical rectification (OR) of near-infrared femtosecond pulses in
DSTMS.
